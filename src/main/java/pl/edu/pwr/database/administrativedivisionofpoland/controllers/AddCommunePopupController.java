...
public class AddCommunePopupController extends BaseCommunePopupController implements Initializable {
    @FXML
    ...
    public AddCommunePopupController(IResultReceiver resultFetcher, IDataSender requestSender) {
